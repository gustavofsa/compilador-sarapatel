...
public final class ADecConsDecsVarConst extends PDecsVarConst
{
    private PDecCons _decCons_;

    public ADecConsDecsVarConst()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecConsDecsVarConst(
    ...
    {
        ((Analysis) sw).caseADecConsDecsVarConst(this);
    }
