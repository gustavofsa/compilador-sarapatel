...
public final class ACondSeSenaoFechadaDeclFechada extends PDeclFechada
{
    private TSe _se_;
    private TParEsq _parEsq_;
    private PExp _exp_;
    private TParDir _parDir_;
    private PDeclFechada _esq_;
    private TSenao _senao_;
    private PDeclFechada _dir_;

    public ACondSeSenaoFechadaDeclFechada()
    {
        // Constructor
    }
    ...
    public ACondSeSenaoFechadaDeclFechada(
        ...
        @SuppressWarnings("hiding") PDeclFechada _esq_,
        @SuppressWarnings("hiding") TSenao _senao_,
        @SuppressWarnings("hiding") PDeclFechada _dir_)
    {
        // Constructor
        setSe(_se_);
    ...
    public Object clone()
    {
        return new ACondSeSenaoFechadaDeclFechada(
            cloneNode(this._se_),
    ...
    {
        ((Analysis) sw).caseACondSeSenaoFechadaDeclFechada(this);
    }
    ...
    public PDeclFechada getEsq()
    {
        return this._esq_;
    }

    public void setEsq(PDeclFechada node)
    {
        if(this._esq_ != null)
        {
    ...
    public PDeclFechada getDir()
    {
        return this._dir_;
    }

    public void setDir(PDeclFechada node)
    {
        if(this._dir_ != null)
        {
