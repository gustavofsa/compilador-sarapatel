...
public final class ACondSeSenaoAbertaDeclAberta extends PDeclAberta
{
    private TSe _se_;
    ...
    public ACondSeSenaoAbertaDeclAberta()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACondSeSenaoAbertaDeclAberta(
            cloneNode(this._se_),
    ...
    {
        ((Analysis) sw).caseACondSeSenaoAbertaDeclAberta(this);
    }
